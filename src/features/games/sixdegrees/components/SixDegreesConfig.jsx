          ...
          <Card className="p-4 bg-card/50 backdrop-blur-sm border-primary/20">
            ...
            <div className="grid grid-cols-3 gap-3">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Card className="p-4 text-center cursor-pointer border-2 border-border hover:border-primary/50 transition-colors">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Card className="p-4 text-center cursor-pointer border-2 border-primary shadow-[0_0_20px_rgba(251,146,60,0.3)] transition-colors">
          ...
          <Card className="p-4 bg-card/50 backdrop-blur-sm border-primary/20">
            ...
            <div className="space-y-2">
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Card className="p-3 cursor-pointer border-2 border-primary shadow-[0_0_15px_rgba(251,146,60,0.2)] transition-colors">
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Card className="p-3 cursor-pointer border-2 border-border hover:border-primary/50 transition-colors">
                  <div className="flex items-center gap-3">
